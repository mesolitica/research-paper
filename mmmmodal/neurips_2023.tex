...
\begin{figure}[hbt!]
  \centering
  \includegraphics[width=0.6\linewidth]{pic/overall-architecture.jpg} % Replace with your image file
\end{figure}
...
\begin{figure}[hbt!]
  \centering
  \includegraphics[width=0.6\linewidth]{pic/visual.jpg} % Replace with your image file
\end{figure}
...
\begin{figure}[hbt!]
  \centering
  \includegraphics[width=0.6\linewidth]{pic/audio.jpg} % Replace with your image file
\end{figure}
...
We also aim to extend our multimodal model to incorporate video inputs. This involves leveraging any video encoder and pretraining video alignment to enhance the model's ability to comprehend video data. By incorporating video understanding capabilities, our model can offer richer insights and responses across various multimedia contexts.
