...
To generate relationship data for multiple images in our multimodal dataset, we utilized image descriptions and employed Mistral to generate relationships based on the provided image descriptions. The following prompt was used for Mistral to generate the data:

\begin{lstlisting}[breaklines=true]
  paragraph = 'Image 1: Suzuki GSX-S1000GT (2022).
               Image 2: Suzuki Burgman 400 (2021).'
...
\begin{lstlisting}[breaklines=true]
  {
    "image": [
      "pic/Suzuki GSX-S1000GT (2022)_0.jpg",
...
To generate relationship data from multiple audio segments in our multimodal dataset, we utilized audio transcriptions and employed Mistral to generate relationships based on the provided audio transcriptions. The resulting prompts served as instructions for generating replies related to multiple audio relationship data. Below is the prompt used for Mistral to generate the data:

\begin{lstlisting}[breaklines=true]
  paragraph = 'Audio 1: Terima kasih Menteri. Saya jemput....
               Audio 2: dalam video tu saya dah hitamkan....'
...
To generate synthetic image-audio relationship data for our multimodal dataset, we combined images with audio segments and utilized Mistral to generate relationships based on the provided image descriptions and audio transcriptions. The following prompt was used for Mistral to generate the data:
...
\begin{figure}[hbt!]
  \centering
  \includegraphics[width=0.6\linewidth]{pic/audio.png} % Replace with your audio file
\end{figure}
The hyperparameters involves in this pretraining stage are detailed below:
